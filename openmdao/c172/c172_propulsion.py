...
class C172Propulsion(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        # Define inputs
        self.add_input('h', shape=(n,), val=1000.0)  # Altitude
        self.add_input('Ma', shape=(n,), val=0.1)  # Mach number
        self.add_input('omega', shape=(n,), val=2800.0)  # RPM
        ...
        self.declare_partials('F', 'omega', method='fd')
        self.declare_partials('M', 'omega', method='fd')
    ...
    def compute(self, inputs, outputs):
        ...
        V = inputs['Ma'] * a
        omega_RAD = (inputs['omega'] * 2 * np.pi) / 60.0  # rad/s
...
if __name__ == "__main__":
    ...
    model.add_subsystem('propulsion', C172Propulsion(num_nodes=num_nodes))
